...
export default definePluginEntry({
    id: "yad",
    name: "Yad",
    description: `Yandex services plugin v${pkg.version}. ` +
    ...
    register(api) {
        ...
        if (!config?.login) {
            api.logger.warn("Yandex plugin: login is not configured. " +
        ...
        if (enabled.length === 0) {
            api.logger.warn("Yandex plugin: no app passwords configured. " +
